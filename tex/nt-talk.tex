...
% \begin{frame}\frametitle{Idea of the proof}
%     The main task is to show that we have:
%     \begin{equation*}
%         \ell_{\varphi}(g) = \frac{1}{2}\ell_{\varphi}((g\circ f_c)|f_c'|^p).
%     \end{equation*}
% 
...
%     \end{equation*}
%     Proving the above identity is the most technically challenging part of the proof, requiring a subtle operator integration argument.
% \end{frame}
% 
